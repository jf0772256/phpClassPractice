...
//this is the database where we are going to be setting up the connection to the database created: phpClases
  ...
  //$qb->create_newTable("test", $tablecol);
  ...
  // $result = $qb->dropTableByName("testTableFromClass");
  ...
  //$qb->setDBPrefix("");
  //$result = $qb->renameTableName("test_testTableFromClass","jesses_Table");

  //just cleaning up :)
  // $result = $qb->dropTableByName("jesses_Table");
  $table_Name = $qb->getDBPrefix() . "testTableFromClass";
